    ...
    public static Tile createTile(int mapIcon) {
        ...
        switch (mapIcon) {
            ...
            case 37:
                ...
                break;
            case 38:
                tile = new TileExtended("dirt.png", TileEngine.TILE_WIDTH, TileEngine.TILE_HEIGHT, "ground");
                tile.isSolid = true;
                break;
            case 39:
                tile = new TileExtended("dirtCenter.png", TileEngine.TILE_WIDTH, TileEngine.TILE_HEIGHT, "ground");
                tile.isSolid = true;
                break;
            case 40:
                tile = new TileExtended("dirtCenter_rounded.png", TileEngine.TILE_WIDTH, TileEngine.TILE_HEIGHT, "ground");
                tile.isSolid = true;
                break;
            case 41:
                tile = new TileExtended("dirtCliffLeft.png", TileEngine.TILE_WIDTH, TileEngine.TILE_HEIGHT, "ground");
                tile.isSolid = true;
                break;
            case 42:
                tile = new TileExtended("dirtCliffLeftAlt.png", TileEngine.TILE_WIDTH, TileEngine.TILE_HEIGHT, "ground");
                tile.isSolid = true;
                break;
            case 43:
